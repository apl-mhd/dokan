...
class Product(models.Model):
    ...
    purchase_price = models.DecimalField(
        ...
        help_text="Price per base unit (for purchase). Invoice line price = purchase_price × unit.conversion_factor."
    )
    selling_price = models.DecimalField(
        max_digits=12, decimal_places=4, default=0,
        help_text="Price per base unit (for sale). Invoice line price = selling_price × unit.conversion_factor."
    )
